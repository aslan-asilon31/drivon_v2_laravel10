    ...
    <main class="main">
            ...
            <div class="home__container " style="text-align:center;margin-bottom:16px;">
                ...
                <div class="home__data">
                    ...
                    <h2 class="home__subtitle" id="carModel">
                        ...
                        <main id="carousel">
                            <div class="item"><img src="{{asset('frontend/assets/img/featured5.png')}}" alt="" class="about__img"></div>
                            <div class="item"><img src="{{asset('frontend/assets/img/featured4.png')}}" alt="" class="about__img"></div>
                            <div class="item"><img src="{{asset('frontend/assets/img/featured3.png')}}" alt="" class="about__img"></div>
                            <div class="item"><img src="{{asset('frontend/assets/img/featured2.png')}}" alt="" class="about__img"></div>
                            <div class="item"><img src="{{asset('frontend/assets/img/featured1.png')}}" alt="" class="about__img"></div>
                        <main>
            ...
            <div class="popular__container container swiper">
                <div class="swiper-wrapper">
                    <article class="popular__card swiper-slide">
                        ...
                        <img src="{{asset('frontend/assets/img/popular1.png')}}" alt="" class="popular__img">
                    ...
                    <article class="popular__card swiper-slide">
                        ...
                        <img src="{{asset('frontend/assets/img/popular2.png')}}" alt="" class="popular__img">
                    ...
                    <article class="popular__card swiper-slide">
                        ...
                        <img src="{{asset('frontend/assets/img/popular3.png')}}" alt="" class="popular__img">
                    ...
                    <article class="popular__card swiper-slide">
                        ...
                        <img src="{{asset('frontend/assets/img/popular4.png')}}" alt="" class="popular__img">
                    ...
                    <article class="popular__card swiper-slide">
                        ...
                        <img src="{{asset('frontend/assets/img/popular5.png')}}" alt="" class="popular__img">
        ...
        <section class="features section">
            ...
            <div class="features__container container grid">
                <div class="features__group">
                    <img src="{{asset('frontend/assets/img/features.png')}}" alt="" class="features__img">
            ...
            <img src="{{asset('frontend/assets/img/map.png')}}" alt="" class="features__map">
        </section>
            ...
            <div class="featured__container container">
                ...
                <div class="featured__content grid">
                    <article class="featured__card mix tesla">
                        ...
                        <img src="{{asset('frontend/assets/img/featured1.png')}}" alt="" class="featured__img">
                    ...
                    <article class="featured__card mix tesla">
                        ...
                        <img src="{{asset('frontend/assets/img/featured2.png')}}" alt="" class="featured__img">
                    ...
                    <article class="featured__card mix audi">
                        ...
                        <img src="{{asset('frontend/assets/img/featured3.png')}}" alt="" class="featured__img">
                    ...
                    <article class="featured__card mix porsche">
                        ...
                        <img src="{{asset('frontend/assets/img/featured4.png')}}" alt="" class="featured__img">
                    ...
                    <article class="featured__card mix porsche">
                        ...
                        <img src="{{asset('frontend/assets/img/featured5.png')}}" alt="" class="featured__img">
        ...
        <section class="offer section">
            <div class="offer__container container grid">
                <img src="{{asset('frontend/assets/img/offer-bg.png')}}" alt="" class="offer__bg">
                ...
                <img src="{{asset('frontend/assets/img/offer.png')}}" alt="" class="offer__img">
            </div>
        </section>
        ...
        <section class="logos section">
            <div class="logos__container container grid">
                <div class="logos__content">
                    <img src="{{asset('frontend/assets/img/logo1.png')}}" alt="" class="logos__img">
                </div>

                <div class="logos__content">
                    <img src="{{asset('frontend/assets/img/logo2.png')}}" alt="" class="logos__img">
                </div>

                <div class="logos__content">
                    <img src="{{asset('frontend/assets/img/logo3.png')}}" alt="" class="logos__img">
                </div>

                <div class="logos__content">
                    <img src="{{asset('frontend/assets/img/logo4.png')}}" alt="" class="logos__img">
                </div>

                <div class="logos__content">
                    <img src="{{asset('frontend/assets/img/logo5.png')}}" alt="" class="logos__img">
                </div>

                <div class="logos__content">
                    <img src="{{asset('frontend/assets/img/logo6.png')}}" alt="" class="logos__img">
                </div>
            </div>
        </section>
    </main>
